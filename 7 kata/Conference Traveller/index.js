/* 
	...
	Lucy loves to travel. Luckily she is a renowned computer scientist and gets to travel 
	to international conferences using her department's budget.
	...
	and if that leaves her with more than one option, 
	...
	citiesOffered will already be ordered in terms of the relevance of the conferences for 
	Lucy's research (from the most to the least relevant).
	...
	If all of the offered conferences are hosted in cities that Lucy has visited before, the function should return 
	'No worthwhile conferences this year!' (Nothing in Haskell)
...
function conferencePicker (citiesVisited, citiesOffered) {
  let visit = citiesOffered.filter(city => !citiesVisited.includes(city))
  return visit.length ? visit[0] : 'No worthwhile conferences this year!'
}